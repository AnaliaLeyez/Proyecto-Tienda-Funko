...
function initSession() {
  ...
  saveUninitialized: true, //Indica si se debe guardar una sesión que aún no se ha inicializado. Si está configurado en true, se guardará una sesión nueva aunque no haya sido modificada.
  cookie: {
